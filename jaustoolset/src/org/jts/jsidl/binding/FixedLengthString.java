 ...
 *       &lt;attribute name="string_length" use="required"&gt;
 *         &lt;simpleType&gt;
...
@XmlType(name = "")
@XmlRootElement(name = "fixed_length_string")
public class FixedLengthString {

    @XmlAttribute(name = "name", required = true)
    protected String name;
    @XmlAttribute(name = "string_length", required = true)
     ...
     *     
     */
    public void setStringLength(String value) {
