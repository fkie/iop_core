...
JTS::Service* EventsPlugin::get_service()
{
	return p_my_service;
}

void EventsPlugin::create_service(JTS::JausRouter* jaus_router)
{
	p_my_service = new EventsService(jaus_router, static_cast<TransportService *>(get_base_service()));
}

PLUGINLIB_EXPORT_CLASS(iop::EventsPlugin, iop::PluginInterface)
