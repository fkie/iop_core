...
#ifndef ACCESSCONTROLPLUGIN_H
#define ACCESSCONTROLPLUGIN_H
...
class DllExport AccessControlPlugin : public PluginInterface
{
public:
	AccessControlPlugin();
...
protected:
	urn_jaus_jss_core_AccessControl::AccessControlService *p_my_service;
