...
ListManagerPlugin::ListManagerPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* ListManagerPlugin::get_service()
{
	return p_my_service;
}

void ListManagerPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new ListManagerService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::ListManagerPlugin, iop::PluginInterface)
