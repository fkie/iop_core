...
#ifndef LISTMANAGERCLIENTPLUGIN_H
#define LISTMANAGERCLIENTPLUGIN_H
...
class DllExport ListManagerClientPlugin : public PluginInterface
{
public:
	ListManagerClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_core_ListManagerClient::ListManagerClientService *p_my_service;
	urn_jaus_jss_core_ManagementClient::ManagementClientService *p_base_service;
